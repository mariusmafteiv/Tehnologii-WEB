...
<html>
  ...
  <body>
    ...
    <div class="big-box">
      <div class="title"><?php echo $example ? "Exemplu" : $problem['Title']; ?></div>
      <div class="tags"># <?php echo $example ? "Exemplu" : implode(', ', $tags); ?></div>
      <div class="small-box"><?php echo $example ? "Exemplu" : $problem['Description']; ?></div>
      <input type="text" class="text-input" placeholder="Type your answer here...">
      <div class="author-box">
        <img src="assets/avatar.png" class="author-image">
        <div class="author-name"><?php echo $example ? "Exemplu" : $author['FirstName']; ?></div>
        <div class="author-surname"><?php echo $example ? "Exemplu" : $author['LastName']; ?></div>
      </div>
    </div>
