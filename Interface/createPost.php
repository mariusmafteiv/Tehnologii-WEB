...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['title']) && isset($_POST['tags']) && isset($_POST['description']) && isset($_POST['difficulty'])) {
        ...
        // Creează o declarație SQL de inserare a problemei
        ...
        if ($problemStmt->affected_rows > 0) {
            ...
            // Împărțește tagurile într-un array
            $tagArray = explode(',', $tags);

            // Lista pentru a reține ID-urile tagurilor existente sau de inserat
            $tagIds = [];

            // Verifică fiecare tag
