...
<body>
    ...
    $queryProblemsSolved = 'SELECT COUNT(*) as numProblemsSolved FROM solutions WHERE UserId = ?';
    ...
    $queryProblemsSolvedC = 'SELECT COUNT(*) as numProblemsSolvedCorr FROM solutions WHERE UserId = ? AND IsCorrect = "corect"';
    ...
    if ($stmtAttemptedProblems->execute()) {
        ...
        $attemptedProblems = $resultAttemptedProblems->fetch_all(MYSQLI_ASSOC);
    } else {
    ...
    <div class="content">
        ...
        <div class="bottom">
            ...
            <ul class="list">
                <?php foreach ($attemptedProblems as $problem) { ?>
                    <a href="selectedProblem.php?problem_id=<?php echo $problem['Id']; ?>"
